...
using ProyectoXamarin.iOS.Renderers;
using ProyectoXamarin.Maps;

[assembly: ExportRenderer(typeof(CustomMap), typeof(CustomMapRenderer))]
namespace ProyectoXamarin.iOS.Renderers
{
    public class CustomMapRenderer : MapRenderer
    {
        ...
        MKAnnotationView GetViewForAnnotation(MKMapView mapView, IMKAnnotation annotation)
        {
            ...
            annotationView = mapView.DequeueReusableAnnotation(customPin.AutomationId.ToString());
            if (annotationView == null)
            {
                annotationView = new CustomMKAnnotationView(annotation, customPin.AutomationId.ToString());
                annotationView.Image = UIImage.FromFile("ic_coffee_bean.png");
                annotationView.CalloutOffset = new CGPoint(0, 0);
                ((CustomMKAnnotationView)annotationView).Id = customPin.AutomationId.ToString();
            }
...
#endif
        {
            ...
            {
                object target = pin.AutomationId;
